...
// Note: the members.html password-gate logic lives inline in that page
// (not here), so it keeps working even if this shared script fails to
// load for some visitors (a strict ad-blocker, a caching hiccup, etc.).
